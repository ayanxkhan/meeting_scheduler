...
function Hero() {
  return (
    ...
    <div className="flex flex-row-reverse justify-center items-center  my-20 ">
      <Image src='/imgproject.webp' width={500} height={500}/>


      
        {/* <div className='hidden lg:block'>
            <Image src='/imgproject.webp' width={100} height={100}
